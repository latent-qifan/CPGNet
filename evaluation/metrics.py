...
if __name__ == '__main__':
    ...
    img_path = os.path.join(PROJECT_ROOT, "results/PCOD")
    mask_path = os.path.join(PROJECT_ROOT, "datasets/PCOD/test/gt")
    ...
    with open(os.path.join(PROJECT_ROOT, "results/PCOD/results.txt"), "a") as f:
